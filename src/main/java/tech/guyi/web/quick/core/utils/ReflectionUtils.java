...
public class ReflectionUtils {
    ...
    public static Type[] getGenericType(Class<?> classes){
        ParameterizedTypeImpl type = (ParameterizedTypeImpl) classes.getGenericSuperclass();
    ...
    public static List<String> getFieldNames(Class<?> classes){
        return Arrays.stream(classes.getMethods())
                ...
                .map(method -> {
                    ...
                    name = name.replace("get","").replace("is","");
